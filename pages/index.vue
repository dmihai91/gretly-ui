  ...
  <div>
    <div class="position-relative hero-section">
      ...
      <section class="section-shaped my-0">
        <div class="shape shape-style-1 shape-custom shape-skew" />
            ...
            <div class="row">
              <div class="col-lg-6">
                ...
                <p class="lead  text-white">
                  The design system comes with four pre-built pages to help you get started faster. You can change the
        ...
        <div class="row row-grid align-items-center">
          ...
          <div class="col-lg-6 order-lg-1">
            ...
            <card shadow class="shadow-lg--hover mt-5">
              <div class="d-flex px-3">
                <div>
                  <icon name="ni ni-satisfied" gradient="success" color="white" shadow rounded />
                </div>
                <div class="pl-4">
            ...
            <card shadow class="shadow-lg--hover mt-5">
              <div class="d-flex px-3">
                <div>
                  <icon name="ni ni-active-40" gradient="warning" color="white" shadow rounded />
                </div>
                <div class="pl-4">
      ...
      <div class="container pt-lg pb-300">
        <div class="row text-center justify-content-center">
          <div class="col-lg-10">
            ...
            <p class="lead text-white">
              According to the National Oceanic and Atmospheric Administration, Ted, Scambos, NSIDClead scentist, puts
              the potentially record low maximum sea ice extent tihs year down to low ice.
            </p>
          </div>
        </div>
