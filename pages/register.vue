<template>
	<!-- Register Layout -->
	<auth-form :slogan="$t('register_slogan')" ilustration-path="images/register-illustration.jpg">
		...
		<div class="card bg-secondary shadow border-0">
			...
			<div class="card-body px-lg-5 py-lg-4">
				...
				<form role="form" id="register-form" class="mt-4 px-4" @submit.prevent="submitForm">
					<!-- username field -->
					...
					<div class="form-group mb-3">
						...
						/>
						<div class="error" v-if="emailValidationField.$invalid">
					...
					<div class="form-group mb-3">
						...
						/>
						<div class="error" v-if="nameValidationField.$invalid">
...
export default class Register extends Vue {
	...
	async submitForm(evt: Event) {
		this.$v.$touch();
		try {
			if (!this.$v.$invalid) await AuthService.register(this.form);
		} catch (err) {
			console.log(err);
		}
	}
