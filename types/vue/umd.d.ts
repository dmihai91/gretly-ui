...
import { DefaultData, DefaultProps, DefaultMethods, DefaultComputed, PropsDefinition } from 'vue/types/options'
...
declare namespace Vue {
  ...
  export type AsyncComponent<Data = DefaultData<never>, Methods = DefaultMethods<never>, Computed = DefaultComputed, Props = DefaultProps> = V.AsyncComponent<
    Data,
    Methods,
    Computed,
    Props
