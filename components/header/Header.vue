  ...
  <header class="header-global">
    <base-nav class="navbar-main" transparent type="" effect="light" expand>
      ...
      <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
        <li class="nav-item">
          <router-link to="/web-apps-builder" class="nav-link d-lg-none">
            Webapps builder
          </router-link>
          <router-link to="/web-apps-builder" class="d-none nav-link d-lg-block">
            Webapps builder
          </router-link>
        </li>
      ...
      <ul class="navbar-nav align-items-lg-center ml-lg-auto">
        <li class="nav-item">
          <router-link to="/login" class="nav-link d-lg-none font-weight-bold">
            {{ $t('sign_in') }}
          </router-link>
        ...
        <li class="nav-item">
          <router-link to="/register" class="nav-link d-lg-none font-weight-bold">
            {{ $t('get_started') }}
          </router-link>
